...
<div id="formProd" class="cadre">
	<f:form modelAttribute="produit" action="saveProd" method="post"
		...
		<table>
			<tr>
				<td>ID Produit</td>
				<td><f:input path="idProduit" readonly="true" cssClass="cache"/></td>
...
<table class="tab1">
<tr>
<th>ID</th><th>Désignation</th><th>DESCRIPTION</th><th>Catégorie</th><th>Prix</th><th>Quantié</th><th>Selected</th><th>PHOTO</th>
</tr>
...
<td>${p.quantite}</td>
<td>${p.selected}</td>
<td><img src="photoProd?idProd=${p.idProduit}" width="200" height="150"/></td>
